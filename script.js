...
function setTheme(theme){
    ...
    root.style.setProperty("--text","#2F2F2F");
    root.style.setProperty("--subtitle","#6E6E6E");
    root.style.setProperty("--green","#BDBDBD");
    root.style.setProperty("--red","#8A8A8A");
    menu.style.background="#2F2F2F";
    }
...
function removeTask(index){
    ...
    const confirmar = confirm("Tem certeza que deseja apagar esta tarefa? 🗑️");
    ...
    tasks.forEach((task,index)=>{
        ...
        <div class="card">
            ...
            <div class="info">
                ...
                ${task.weekly ? '<span class="weekly"> • 🔁 Semanal</span>' : ''}
            ...
            <div class="actions">
                ...
                <button class="finish" onclick="toggle(${index})">
